        ...
        <div style={{position: 'relative', zIndex: 0}}>
            <section className={"behind-div"} hidden={isOpen}>
                <RegisterInterest
                    ...
                    email={email}
                    continueButton={<span className={`hover-btn ${buttonAnimation ? 'animate' : ''} ${isOpen ? 'open' : 'closed '}`} onClick={handleClick}>
            ...
            >
                {!isOpen ?
                    <RegisterInterest isPrimary={false} handleInputChange={handleInputChange} email={email} continueButton={<span className="hover-btn2 " onClick={handleClick}>
